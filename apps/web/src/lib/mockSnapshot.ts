...
export const MOCK_STATUS_SNAPSHOT: StatusSnapshot = {
  ...
  incidents: [
    ...
    {
      id: 'inc-231',
      title: 'Scheduled maintenance for event storage indexes',
      status: 'scheduled',
      impact: 'maintenance',
      startedAt: '2026-04-20T22:00:00.000Z',
      summary: 'Read latency may briefly increase while reporting indexes are rebuilt.',
  ...
  maintenance: [
    {
      ...
      window: '20 Apr 2026, 22:00 to 23:30 UTC',
      summary: 'Reporting exports may trail by up to 10 minutes while historical indexes are rebuilt.',
      services: ['analytics-export'],
    },
    {
      id: 'mnt-32',
      title: 'Webhook delivery certificate rollover',
      window: '23 Apr 2026, 05:00 to 05:30 UTC',
      summary: 'Callbacks continue normally, but some destinations may show a brief TLS re-negotiation.',
      services: ['alerts-pipeline'],
    },
  ],
}
